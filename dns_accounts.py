...
def lambda_handler(event, context):
    ...
    try:
        ...
        Logger.error(f"Error creating Organizations client: {str(e)}")
        return {'statusCode': 500, 'body': f"Error creating Organizations client: {str(e)}"}
    ...
    for account in accounts:
        ...
        credentials = assume_role_chain(account_id)
        if credentials:
            ...
            Logger.error(f"Skipping account {account_id} due to invalid credentials")
