...
def lambda_handler(event, context):
    try:
        ...
        # List accounts and process management account
        ...
        # Step 3: Switch back to Lambda account's SecurityAuditRole
        set_aws_credentials(lambda_audit_role)
        ...
        for account in accounts:
            ...
            if account_id not in [LAMBDA_ACCOUNT_ID, MANAGEMENT_ACCOUNT_ID]:
                ...
                if account_role:
                    ...
                    unset_aws_credentials()  # Unset credentials after processing each account
...
def retry_with_backoff(func, max_attempts=5, backoff_factor=1.5):
    attempts = 0
